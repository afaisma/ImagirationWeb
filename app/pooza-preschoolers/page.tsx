    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-5">
              <span className="bg-gradient-to-r from-white to-amber-200 bg-clip-text text-transparent">POOZA for Preschoolers</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-amber-700 font-bold rounded-xl shadow-md hover:bg-amber-50 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
              >
      ...
      <section className="bg-amber-50 border-t border-amber-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 bg-amber-600 text-white font-semibold rounded-xl shadow hover:bg-amber-700 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
          >
            Get in Touch
