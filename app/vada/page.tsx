    ...
    <>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3 bg-white text-teal-700 font-semibold rounded-xl hover:bg-teal-50 transition-colors shadow"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <img
              src="https://imagiration.com/wp-content/uploads/2022/06/314x0w-1.webp"
              alt="VADA app"
      ...
      <section className="bg-gray-50 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700 transition-colors shadow"
          >
            Contact Us
