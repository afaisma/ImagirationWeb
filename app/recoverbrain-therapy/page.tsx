    ...
    <>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-rose-700 font-bold rounded-xl shadow-md hover:bg-rose-50 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          <div className="md:w-1/2">
            ...
            <img
              src="/images/2018/12/2732x2048.png"
      ...
      <section className="bg-rose-50 border-t border-rose-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 bg-rose-600 text-white font-semibold rounded-xl shadow hover:bg-rose-700 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
          >
            Get in Touch
